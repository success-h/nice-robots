      ...
      `}
		>
			<div className='flex flex-col h-full'>
				{/* Header Section */}
				<div className='relative p-4 border-b border-sidebar-border bg-sidebar-accent space-y-3'>
					<Link
						href={'/'}
						onClick={() => {
							setCurrentChat(null);
					...
					{sidebarOpen && (
						<button
							...
							className='absolute top-4 right-4 p-2.5 text-sidebar-foreground hover:text-sidebar-foreground rounded-xl bg-card/90 backdrop-blur-sm hover:bg-card transition-all shadow-md hover:shadow-lg border border-sidebar-border z-10'
